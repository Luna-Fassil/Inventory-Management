...
class TestUserManager(unittest.TestCase):
    ...
    def test_add_user(self):
        ...
        data = {"username": "test_user", "password": "password123", "role": "employee"}
    ...
    def test_edit_user(self):
        ...
        updated_data = {"id": 0, "username": "updated_user", "role": "manager"}
        ...
        invalid_data = {"id": 99, "username": "nonexistent", "role": "employee"}
